...
def test_codex_adapter_has_exact_m16_verification_scope() -> None:
    ...
    assert "docs/evidence/m35_triagent_review_scope.md" in text
    assert "6bf175704a096dad527522232311ad77d4c79b86" in text
...
def test_codex_adapter_has_exact_m39_minimal_motion_scope() -> None:
    ...
    assert "M39 physical G1 writer-observation timestamp review" in route_condition
    for required in (
    ...
    for required in (
        ...
        "0cd93a8abf7af689ff36d0f00a9a9fd63b9e2a01cd1c4f63af76698284648023",
